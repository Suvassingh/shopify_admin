...
class _AllUserScreenState extends State<AllUserScreen> {
  final GetUserLengthController getUserLengthController = Get.put(GetUserLengthController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Obx((){
          return Text("All-User (${getUserLengthController.userCollectionLength.toString()}) ",style: TextStyle(color: AppConstant.appTextColor,fontWeight: FontWeight.bold),);
        }),
